...
/**
 * Endpoint interno che genera la risposta del bot.
 * Viene usato sia dal sito che dal webhook WhatsApp.
 *
 * Body atteso:
 * {
 *   "input": "testo dell'utente",
 *   "sector": "barbiere" | "altro" (opzionale)
 * }
 *
 * Risposta:
 * { "reply": "testo di risposta del bot" }
 */
...
Aiuta il cliente con:
- informazioni su servizi, prezzi e orari;
- richieste di prenotazione;
- richieste di modifica/cancellazione.
Quando non puoi fare qualcosa direttamente, spiega in modo semplice cosa deve fare il cliente.`
